...
public class Base_Frame extends javax.swing.JFrame {
    ...
    CustomerList_Frame customerList_Frame;
    DelCus_Frame delCus_Frame;
    EmployeeList_Frame employeeList_Frame;
    AddEmployee_Frame addEmployee_Frame;
    DelEmp_Frame delEmp_Frame;
    SetStoreInfo_Frame setStoreInfo_Frame;
    StoreInfo_Frame storeInfo_Frame;
    public static Settings_Frame settings_Frame;
    SaleWithCart_Frame saleWithCart_Frame;
    Purchase_Frame purchase_Frame;
    AboutM aboutM;
...
//</editor-fold>
    ...
    private void jButtonDelCusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDelCusActionPerformed
        if (delCus_Frame == null) {
            delCus_Frame = new DelCus_Frame();
        }else
            delCus_Frame.setVisible(true);
    ...
    private void jButtonShowCusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonShowCusActionPerformed
        if (customerList_Frame == null) {
            customerList_Frame = new CustomerList_Frame();
        }else
            customerList_Frame.setVisible(true);
    ...
    private void jButtonSetStoreInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSetStoreInfoActionPerformed
        if (setStoreInfo_Frame == null) {
            setStoreInfo_Frame = new SetStoreInfo_Frame();
        }else
            setStoreInfo_Frame.setVisible(true);
    ...
    private void jButtonShowStoreInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonShowStoreInfoActionPerformed
        if (storeInfo_Frame == null) {
            storeInfo_Frame = new StoreInfo_Frame();
        }else
            storeInfo_Frame.setVisible(true);
    ...
    private void jButtonAddEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddEmpActionPerformed
        if (addEmployee_Frame == null) {
            addEmployee_Frame = new AddEmployee_Frame();
        }else
    ...
    private void jButtonDelEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDelEmpActionPerformed
        if (delEmp_Frame == null) {
            delEmp_Frame = new DelEmp_Frame();
        }else
            delEmp_Frame.setVisible(true);
    ...
    private void jButtonShowEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonShowEmpActionPerformed
        if (employeeList_Frame == null) {
            employeeList_Frame = new EmployeeList_Frame();
        }else
            employeeList_Frame.setVisible(true);
    ...
    private void jButtonSellActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSellActionPerformed
        if (saleWithCart_Frame == null) {
            saleWithCart_Frame = new SaleWithCart_Frame();
        }else
            saleWithCart_Frame.setVisible(true);
    ...
    private void jButtonAboutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAboutActionPerformed
        if (aboutM == null) {
            ...
            aboutM.setVisible(true);
    }//GEN-LAST:event_jButtonAboutActionPerformed

    private void jButtonReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReportActionPerformed
        if (report_Frame == null) {
            report_Frame = new Report_Frame();
        }else
    ...
    private void jButtonPur1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPur1ActionPerformed
        if (purchase_Frame == null) {
            purchase_Frame = new Purchase_Frame();
        }else
    ...
    private void jButtonInven1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInven1ActionPerformed
        if (inventory_Frame == null) {
            inventory_Frame = new Inventory_Frame();
        }else
    ...
    private void jButtonSettingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSettingsActionPerformed
        if (settings_Frame == null) {
            settings_Frame = new Settings_Frame();
            LoginM_Frame.base_Frame.setVisible(false);
        }else
            LoginM_Frame.base_Frame.setVisible(false);

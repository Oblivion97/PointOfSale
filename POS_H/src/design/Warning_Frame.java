...
public class Warning_Frame extends javax.swing.JFrame {
    ...
    public Warning_Frame(String warning) {
    ...
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Warning_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Arista 2.0 Light", 1, 14)); // NOI18N
        ...
        jButtonOk.setBounds(170, 110, 77, 32);
